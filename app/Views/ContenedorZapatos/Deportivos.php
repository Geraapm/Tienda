...
<div class="container mt-4">
    ...
    <div class="row g-4">
        <?php
$imagenes_deportivos = [
    'zapato-deportivo.jpeg',
    'zapatodeportivo2.jpg',
    'zapatodeportivo3.jpg',
    'zapatodeportivo4.jpg'
];
$i = 0;
foreach ($productos as $producto): 
    $producto['imagen'] = $imagenes_deportivos[$i % count($imagenes_deportivos)];
    $i++; ?>
            <div class="col-md-4">
